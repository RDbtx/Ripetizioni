#include "esercitazione_secondo_parziale1.h"
...
#define MAXLEN 50
    ...
    int len = leggiPubblicazioni("Esercizi/ricercatori.txt", pubb);

    int anno;
    printf("Inserire l'anno:\n");
    scanf("%d", &anno);

    numero_elementi = leggiPubblicazioni(pubb, "Esercizi/ricercatori.txt");
